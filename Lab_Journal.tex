...
\begin{center}
\HRule \\[0.4cm]
{\Huge \bfseries Laboratory Journal \\[0.5cm] \Large Doctor of Science}\\[0.4cm] % Degree
\HRule \\[1.5cm]
\end{center}
}
\author{\Huge Soroush Arabi \\ \\ \LARGE soroush.physics@gmail.com \\[2cm]} % Your name and email address
\date{Beginning 1 February 2019} % Beginning date
\maketitle
...
\labday{Friday, 1 February 2019}

\experiment{Registration, formalities, and paperworks}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{Figures/example_figure.png}
\end{center}
